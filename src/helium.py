...
def run():
    # determine tank sizing in terms of pressurization
    # utilizes bernoulli's equation for mdot calculations and boyle's law for an ideal pressure transfering simulation
    # assume extra ullage compared to optimal results
    # wdot = Qp = Cd*A*sqrt(2gpdeltaP)
